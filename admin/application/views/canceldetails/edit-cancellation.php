         ...
         <div class="col-md-12">
                  ...
                  <div class="box-body">
                     <div class="col-md-6">                      
						...
						<div class="form-group has-feedback">
                           ...
                           <input tabindex="3" type="text" class="form-control" name="percentage" value="<?php echo $data->percentage; ?>" placeholder="Percentage">
			...
			?>					
						<div class="form-group has-feedback">
							...
							<input tabindex="5" type="radio" <?php echo $c; ?> name="type"  value="percentage"> Percentage
							
							<input  tabindex="5"type="radio" <?php echo $d; ?> name="type"  value="flat"> Flat <br>
						</div>
                   ...
                   <div class="col-md-6">
						...
						<div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input tabindex="2" type="text" id="timepicker_cancellation" name="cancel_time" value="<?php echo $data->cancel_time; ?>" class="form-control">
						...
						<div class="form-group has-feedback">
                           ...
                           <input tabindex="4" type="text" class="form-control" name="flat" value="<?php echo $data->flat; ?>" placeholder="Flat">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
